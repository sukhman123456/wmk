    ...
    <section className="section-spacing bg-[#071525] text-white border-b border-[#101E32]">
      <div className="container-site">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <h2 className="font-display text-[clamp(2.2rem,4.5vw,3.8rem)] font-extrabold tracking-[-0.03em] text-white uppercase leading-[1.04]">
            The Right Team for the Job
          </h2>
        </div>

        {/* 6 Benefits Grid (6-col desktop, 3-col tablet, 2-col/1-col mobile) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5">
          {whyChooseItems.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="group rounded-2xl border border-white/10 bg-[#0B1B30] p-6 flex flex-col justify-between hover:border-[#F5BF3C] hover:bg-[#10243C] transition-all duration-300 shadow-sm"
              >
                <div>
                  <div className="grid h-12 w-12 place-items-center rounded-xl bg-white/5 border border-white/15 text-[#F5BF3C] transition-all group-hover:bg-[#F5BF3C] group-hover:text-[#071525] group-hover:scale-105 mb-5">
                    <Icon className="h-6 w-6" />
                  </div>
                  <h3 className="font-display text-sm sm:text-base font-bold uppercase tracking-tight text-white group-hover:text-[#F5BF3C] transition-colors leading-snug">
                    {item.title}
                  </h3>
                </div>
      ...
      <div className="container-site">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            <div className="relative aspect-16/9 sm:aspect-16/10 rounded-2xl overflow-hidden border border-[#E2E8F0] shadow-md bg-[#071525]">
              <img
              ...
              <div className="absolute bottom-4 left-4 rounded-md bg-black/80 border border-white/20 px-3.5 py-1.5 text-xs font-display font-bold uppercase tracking-wider text-white backdrop-blur-md shadow-md">
                Before
              </div>
              <div className="absolute bottom-4 right-4 rounded-md bg-[#F5BF3C] px-3.5 py-1.5 text-xs font-display font-black uppercase tracking-wider text-[#071525] shadow-lg">
                After
              </div>
            </div>
          ...
          <div className="lg:col-span-5 rounded-2xl border border-[#E2E8F0] bg-[#F7F9FC] p-7 sm:p-9 flex flex-col justify-between shadow-xs">
            <div>
              <div className="inline-flex items-center gap-1.5 rounded-md bg-white border border-[#E2E8F0] px-3 py-1 text-[0.68rem] font-display font-bold uppercase tracking-wider text-[#0B1B30] mb-4 shadow-xs">
                <span className="h-1.5 w-1.5 rounded-full bg-[#F5BF3C]" />
                <span>Featured Project</span>
              </div>

              <h3 className="font-display text-2xl sm:text-3xl font-extrabold uppercase text-[#0B1B30] tracking-tight">
                Roof Replacement
              </h3>
              ...
              <div className="mt-6 pt-6 border-t border-[#E2E8F0] space-y-3.5">
                {[
                  ...
                  <div key={point} className="flex items-center gap-3 text-sm font-semibold text-[#0B1B30]">
            ...
            <div className="mt-8 pt-6 border-t border-[#E2E8F0]">
              <a
                href="#contact"
                className="w-full inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[#F5BF3C] font-display text-xs sm:text-sm font-extrabold uppercase tracking-wider text-[#071525] hover:bg-[#FFD45A] hover:shadow-[0_4px_16px_rgba(245,191,60,0.35)] transition-all shadow-sm"
              >
...
/* =========================================================================
   ...
   5 numbered steps with connecting arrows on desktop, vertical on mobile.
   ========================================================================= */
const processSteps = [
  {
    step: 1,
    ...
    <section className="section-spacing bg-[#F7F9FC] border-b border-[#E2E8F0]">
      <div className="container-site">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 sm:mb-18">
          ...
          <p className="mt-3 text-base sm:text-lg text-[#64748B] leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative">
          {processSteps.map((s, index) => (
            ...
            >
              ...
              {/* Horizontal Connecting Arrow (Visible between items on desktop) */}
              {index < processSteps.length - 1 && (
                <div className="hidden md:block absolute top-7 left-[calc(50%+2.5rem)] right-[calc(-50%+2.5rem)] h-0.5 bg-[#E2E8F0] z-0">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative overflow-hidden rounded-2xl border border-[#E2E8F0] shadow-md group">
            <img
              ...
              loading="lazy"
            />
            <div className="absolute bottom-4 left-4 rounded-lg bg-white/95 px-3.5 py-1.5 text-xs font-semibold text-[#0B1B30] border border-[#E2E8F0] shadow-xs backdrop-blur-xs flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-[#F5BF3C]" />
          ...
          <div className="lg:col-span-6">
            ...
            <div className="mt-6 space-y-4 text-base sm:text-lg text-[#64748B] leading-relaxed">
              <p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <a
                href="#contact"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[#F5BF3C] px-7 font-display text-xs sm:text-sm font-extrabold uppercase tracking-wider text-[#071525] hover:bg-[#FFD45A] hover:shadow-[0_4px_16px_rgba(245,191,60,0.35)] transition-all shadow-sm"
              >
              ...
              <a
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-[#071525] bg-[#071525] px-7 font-display text-xs sm:text-sm font-bold uppercase tracking-wider text-white hover:bg-[#101E32] transition-colors"
              >
    ...
    <section id="reviews" className="section-spacing bg-white border-b border-[#E2E8F0] scroll-mt-20">
      <div className="container-site">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          {/* Rating Badge */}
          <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-[#E2E8F0] bg-[#F7F9FC] px-4 py-1.5 text-xs font-display font-bold uppercase tracking-wider text-[#0B1B30]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviewsList.map((rev) => (
            <div
              key={rev.author}
              className="rounded-2xl border border-[#E2E8F0] bg-[#F7F9FC] p-7 flex flex-col justify-between shadow-xs hover:border-[#F5BF3C] transition-colors"
            >
              <div>
                {/* 5 Gold Stars */}
                <div className="flex items-center gap-1 text-[#F5BF3C] text-sm mb-4">
                  {[...Array(5)].map((_, i) => (
                    <span key={i}>★</span>
                  ))}
                </div>

                <p className="text-sm sm:text-base text-[#0B1B30] leading-relaxed italic">
                  "{rev.quote}"
                </p>
              </div>
              ...
              <div className="mt-6 pt-5 border-t border-[#E2E8F0] flex items-center gap-3">
                <div className="grid h-10 w-10 place-items-center rounded-full bg-[#071525] text-[#F5BF3C] font-display font-bold text-xs">
                  {rev.author.charAt(0)}
                </div>
                <div>
                  <h4 className="font-display text-sm font-bold text-[#0B1B30]">
                    {rev.author}
                  </h4>
      ...
      <div className="container-site">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="mt-3 text-base sm:text-lg text-[#64748B] leading-relaxed max-w-xl">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              {serviceAreas.map((area) => (
                <div key={area} className="flex items-center gap-2.5 text-sm font-semibold text-[#0B1B30]">
                  <div className="grid h-5 w-5 place-items-center rounded-full bg-[#F5BF3C]/20 text-[#F5BF3C] shrink-0">
                    <Check className="h-3.5 w-3.5 stroke-[3]" />
                  </div>
                  <span>{area}</span>
          ...
          <div className="lg:col-span-5 rounded-2xl border border-[#E2E8F0] bg-white p-7 sm:p-8 shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-6">
              ...
              <h3 className="font-display text-lg font-bold text-[#0B1B30]">
...
export function FinalCta() {
  return (
    <section className="relative section-spacing bg-[#071525] text-white border-b border-[#101E32] overflow-hidden">
      ...
      <div className="container-site relative z-10 text-center max-w-3xl mx-auto">
        <h2 className="font-display text-[clamp(2.2rem,5vw,4.5rem)] font-extrabold tracking-[-0.03em] text-white uppercase leading-[1.02]">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#contact"
            className="w-full sm:w-auto inline-flex h-13 sm:h-14 items-center justify-center gap-2.5 rounded-lg bg-[#F5BF3C] px-8 font-display text-sm font-extrabold uppercase tracking-wider text-[#071525] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#FFD45A] hover:shadow-[0_4px_24px_rgba(245,191,60,0.4)] active:translate-y-0 active:scale-95 shadow-md"
          >
          ...
          <a
            href={business.phoneHref}
            className="w-full sm:w-auto inline-flex h-13 sm:h-14 items-center justify-center gap-2.5 rounded-lg border border-white/30 bg-[#071525]/60 px-8 font-display text-sm font-bold uppercase tracking-wider text-white backdrop-blur-md transition-all duration-200 hover:border-[#F5BF3C] hover:text-[#F5BF3C] hover:bg-[#071525]/85 hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
          >
